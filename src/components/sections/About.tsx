...
export default function About() {
  ...
  return (
    <section className="relative py-16 bg-gray-50 z-10 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/2">
            ...
            <TextReveal delay={0.1}>
              <h3 className="text-4xl md:text-6xl font-bold font-outfit leading-tight mb-8 text-black">
                More than a gym.<br />
                A luxury fitness<br />
                sanctuary.
              </h3>
            ...
            <TextReveal delay={0.2}>
              <p className="text-lg text-black/60 mb-8 max-w-md font-outfit">
          ...
          <div className="lg:w-1/2 grid gap-6">
            {features.map((feature, i) => (
              <TextReveal key={i} delay={0.3 + (i * 0.1)}>
                <GlassCard className="flex items-start gap-8 relative overflow-hidden group hover:-translate-y-2 transition-all duration-500 shadow-sm hover:shadow-xl bg-white border-gray-200">
                  <div className="flex-shrink-0 p-5 bg-white rounded-2xl shadow-md border border-black/5 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 relative z-10">
                    {feature.icon}
                  </div>
                  <div className="relative z-10">
                    <h4 className="text-2xl font-bold font-outfit mb-2 text-black">{feature.title}</h4>
                    <p className="text-black/60 font-outfit text-lg">{feature.desc}</p>
                  </div>
